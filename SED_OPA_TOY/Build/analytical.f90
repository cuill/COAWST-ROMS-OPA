...
!
      IF (Lanafile.and.(tile.eq.0)) THEN
        ANANAME( 7)="/ches/data10/VIMSMPC/lcui/CSOMIO/SED_OPA_TOY/Include/ana_grid.h"
      END IF
      RETURN
...
!
      IF (Lanafile.and.(tile.eq.0)) THEN
        ANANAME(31)="/ches/data10/VIMSMPC/lcui/CSOMIO/SED_OPA_TOY/Include/ana_stflux.h"
      END IF
      RETURN
...
!
      IF (Lanafile.and.(tile.eq.0)) THEN
        ANANAME(37)="/ches/data10/VIMSMPC/lcui/CSOMIO/SED_OPA_TOY/Include/ana_wwave.h"
      END IF
      RETURN
