...
!
!svn $Id: get_state.F 885 2017-12-27 23:18:30Z arango $
!================================================== Hernan G. Arango ===
...
!
      CALL wclock_on (ng, IDmod, 42, 202, "ROMS/Utility/get_state.F")
!
...
!
      ...
      IF (FoundError(exit_flag, NoError, 237,                           &
...
!
      IF (((model.eq.0).or.(model.eq.iNLM)).and.(nrrec(ng).ne.0)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 265,                         &
     &                 "ROMS/Utility/get_state.F")) RETURN
      END IF
!
...
!
     ...
     &                          OCEAN(ng) % zeta(:,:,Tindex))
            END IF
            IF (FoundError(status, nf90_noerr, 608,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 628,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        OCEAN(ng) % rzeta)
            IF (FoundError(status, nf90_noerr, 651,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 671,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          OCEAN(ng) % ubar(:,:,Tindex))
            END IF
            IF (FoundError(status, nf90_noerr, 710,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 730,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 773,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          OCEAN(ng) % vbar(:,:,Tindex))
            END IF
            IF (FoundError(status, nf90_noerr, 812,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 832,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        OCEAN(ng) % rvbar)
            IF (FoundError(status, nf90_noerr, 855,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 875,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          OCEAN(ng) % u(:,:,:,Tindex))
            END IF
            IF (FoundError(status, nf90_noerr, 912,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 932,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        OCEAN(ng) % ru)
            IF (FoundError(status, nf90_noerr, 955,                     &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 975,                  &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          OCEAN(ng) % v(:,:,:,Tindex))
            END IF
            IF (FoundError(status, nf90_noerr, 1010,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1030,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1073,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                            TRIM(ncname)
              END IF
              exit_flag=4
              IF (FoundError(exit_flag, nf90_noerr, 1130,               &
     &                       "ROMS/Utility/get_state.F")) THEN
                RETURN
              END IF
            END IF
...
!
     ...
     &                        Fscl, Fmin,Fmax,                          &
     &                        MIXING(ng) % AKv)
            IF (FoundError(status, nf90_noerr, 1311,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1338,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1388,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin,Fmax,                          &
     &                        MIXING(ng) % AKt(:,:,:,isalt))
            IF (FoundError(status, nf90_noerr, 1412,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1439,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        MIXING(ng) % tke)
            IF (FoundError(status, nf90_noerr, 1603,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1623,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        MIXING(ng) % gls)
            IF (FoundError(status, nf90_noerr, 1646,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1666,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        MIXING(ng) % Lscale)
            IF (FoundError(status, nf90_noerr, 1689,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1709,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        MIXING(ng) % Akk)
            IF (FoundError(status, nf90_noerr, 1732,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1752,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                        Fscl, Fmin, Fmax,                         &
     &                        MIXING(ng) % Akp)
            IF (FoundError(status, nf90_noerr, 1776,                    &
     &                     "ROMS/Utility/get_state.F")) THEN
              IF (Master) THEN
     ...
     &                          TRIM(ncname)
            END IF
            exit_flag=4
            IF (FoundError(exit_flag, nf90_noerr, 1796,                 &
     &                     "ROMS/Utility/get_state.F")) THEN
              RETURN
            END IF
          END IF
...
!
     ...
     &                          SEDBED(ng) % bed_frac(:,:,:,i))
              IF (FoundError(status, nf90_noerr, 1824,                  &
     &                       "ROMS/Utility/get_state.F")) THEN
                IF (Master) THEN
     ...
     &                              InpRec, TRIM(ncname)
              ...
              ELSE
                IF (Master) THEN
                  WRITE (stdout,70) TRIM(Vname(2,idfrac(i))), Fmin, Fmax
                END IF
              END IF
            ELSE
              IF (Master) THEN
     ...
     &                            TRIM(ncname)
              END IF
              exit_flag=4
              IF (FoundError(exit_flag, nf90_noerr, 1844,               &
     &                       "ROMS/Utility/get_state.F")) THEN
                RETURN
              END IF
            END IF
...
!
     ...
     &                          SEDBED(ng) % bed_mass(:,:,:,Tindex,i))
              IF (FoundError(status, nf90_noerr, 1867,                  &
     &                       "ROMS/Utility/get_state.F")) THEN
                IF (Master) THEN
     ...
     &                              InpRec, TRIM(ncname)
              ...
              ELSE
                IF (Master) THEN
                  WRITE (stdout,70) TRIM(Vname(2,idBmas(i))), Fmin, Fmax
                END IF
              END IF
            ELSE
              IF (Master) THEN
     ...
     &                            TRIM(ncname)
              END IF
              exit_flag=4
              IF (FoundError(exit_flag, nf90_noerr, 1887,               &
     &                       "ROMS/Utility/get_state.F")) THEN
                RETURN
              END IF
            END IF
...
!
     ...
     &                          Fscl, Fmin, Fmax,                       &
     &                          SEDBED(ng) % bed(:,:,:,i))
              IF (FoundError(status, nf90_noerr, 1912,                  &
     &                       "ROMS/Utility/get_state.F")) THEN
                IF (Master) THEN
     ...
     &                              InpRec, TRIM(ncname)
              ...
              ELSE
                IF (Master) THEN
                  WRITE (stdout,70) TRIM(Vname(2,idSbed(i))), Fmin, Fmax
                END IF
              END IF
            ELSE
              IF (Master) THEN
     ...
     &                            TRIM(ncname)
              END IF
              exit_flag=4
              IF (FoundError(exit_flag, nf90_noerr, 1932,               &
     &                       "ROMS/Utility/get_state.F")) THEN
                RETURN
              END IF
            END IF
...
!
     ...
     &                          Fscl, Fmin, Fmax,                       &
     &                          SEDBED(ng) % bottom(:,:,i))
              IF (FoundError(status, nf90_noerr, 2049,                  &
     &                       "ROMS/Utility/get_state.F")) THEN
                IF (Master) THEN
     ...
     &                              InpRec, TRIM(ncname)
              ...
              ELSE
                IF (Master) THEN
                  WRITE (stdout,70) TRIM(Vname(2,idBott(i))), Fmin, Fmax
                END IF
              END IF
            ELSE
              IF (Master) THEN
     ...
     &                            TRIM(ncname)
              END IF
              exit_flag=4
              IF (FoundError(exit_flag, nf90_noerr, 2069,               &
     &                       "ROMS/Utility/get_state.F")) THEN
                RETURN
              END IF
            END IF
...
!
      CALL wclock_off (ng, IDmod, 42, 7610, "ROMS/Utility/get_state.F")
!
