...
!
     ...
     &      'Message Passage: multi-model coupling ............'/)        !73
        ...
        character (len=80) :: my_fc = "/usr/local/intel-2018/compilers_and_libraries_2018.3.222/linux/bin/intel64/ifort"
        character (len=160) :: my_fflags = "-fp-model precise -ip -O3  -free"
