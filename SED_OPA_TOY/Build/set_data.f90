...
!
     ...
     &                    SOURCES(ng) % Qbar,                           &
     &                    update)
          IF (FoundError(exit_flag, NoError, 1055,                      &
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1090,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
        END DO
      END IF
...
!
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1276,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1306,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1336,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
     ...
     &                      update)
            IF (FoundError(exit_flag, NoError, 1346,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
        END IF
      END IF
...
!
     ...
     &                      BOUNDARY(ng) % v_west,                      &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1870,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
     ...
     &                      BOUNDARY(ng) % v_east,                      &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1890,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
     ...
     &                      BOUNDARY(ng) % v_north,                     &
     &                      update)
            IF (FoundError(exit_flag, NoError, 1930,                    &
     &                     "ROMS/Nonlinear/set_data.F")) RETURN
          END IF
        END IF
      END IF
...
!
     ...
     &                        update)
              IF (FoundError(exit_flag, NoError, 1961,                  &
     &                       "ROMS/Nonlinear/set_data.F")) RETURN
            END IF
     ...
     &                        update)
              IF (FoundError(exit_flag, NoError, 1971,                  &
     &                       "ROMS/Nonlinear/set_data.F")) RETURN
            END IF
     ...
     &                        update)
              IF (FoundError(exit_flag, NoError, 1981,                  &
     &                       "ROMS/Nonlinear/set_data.F")) RETURN
            END IF
          END DO
        END IF
...
!
     ...
     &                       CLIMA(ng)%ssh,                             &
     &                       update)
        IF (FoundError(exit_flag, NoError, 2003,                        &
     &                 "ROMS/Nonlinear/set_data.F")) RETURN
      END IF
!
!-----------------------------------------------------------------------
...
!
     ...
     &                       CLIMA(ng)%ubarclm,                         &
     &                       update)
        IF (FoundError(exit_flag, NoError, 2042,                        &
     &                 "ROMS/Nonlinear/set_data.F")) RETURN
!
...
!
     ...
     &                       CLIMA(ng)%vclm,                            &
     &                       update)
        IF (FoundError(exit_flag, NoError, 2103,                        &
     &                 "ROMS/Nonlinear/set_data.F")) RETURN
      END IF
!
!-----------------------------------------------------------------------
...
!
     ...
     &                         CLIMA(ng)%tclm (:,:,:,ic),               &
     &                         update)
          IF (FoundError(exit_flag, NoError, 2156,                      &
     &                   "ROMS/Nonlinear/set_data.F")) RETURN
        END IF
      END DO
      RETURN
