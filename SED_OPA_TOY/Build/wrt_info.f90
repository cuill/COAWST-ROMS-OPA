...
!
     ...
     &                      Tcoef(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 867,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'Scoef',                 &
     &                      Scoef(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 873,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
     ...
     &                      Sd50(:,ng), (/1/), (/NST/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 42,                            &
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'Srho',                  &
     &                      Srho(:,ng), (/1/), (/NST/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 48,                            &
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'Csed',                  &
     &                      Csed(:,ng), (/1/), (/NST/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 54,                            &
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'Wsed',                  &
     &                      Wsed(:,ng), (/1/), (/NST/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 61,                            &
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'Erate',                 &
     &                      Erate(:,ng), (/1/), (/NST/),                &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 67,                            &
     &               "ROMS/Nonlinear/Sediment/sediment_wrt.h")) RETURN
